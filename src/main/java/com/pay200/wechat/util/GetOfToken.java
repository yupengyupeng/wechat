...
/** 
* @author yupeng
* @version 创建时间：2018年12月11日 下午2:29:34 
* 类说明 
*/
public class GetOfToken {
    ...
    /*public static void main(String[] args) {
        ...
        System.out.println("getToken(userId);"+getToken(userId));
        System.out.println("token：117:8J42NA==7C2 的用户ID是："+JudgementToken("118:8J42NA==7C2"));
